...
loginForm.addEventListener("submit", async (e) => {
    ...
    try {
        let response = await fetch(`https://cc-api-nosql-qa.onrender.com/admin/findByUserAdmin/${usernameOrEmail}`);

        if (!response.ok) {
            response = await fetch(`https://cc-api-nosql-qa.onrender.com/admin/findByEmailAdmin/${usernameOrEmail}`);
        }
